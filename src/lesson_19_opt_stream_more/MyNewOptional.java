...
public class MyNewOptional {
    ...
    public static void main(String[] args){
        ...
        // Коллекция сами решайте какая
        // Объект Человек - имя, фамилия, место проживания, номер телефона, почтовый адрес

        // Создать программу, которая может:
            // 1. Фильтровать и выводить данные только по именам
            // 2. Фильтровать и выводить данные только по фамилиям
            // 3. Отсортировать всю книгу по Фамилии
            // 4. Выдать мне данные о всех почтовых адресах
            // 5. Проанализировать почтовые адреса на правильность
    }
